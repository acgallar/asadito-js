$(document).ready(function($) {
	$('#btn_enviar_seleccion').on('click', function(){
	 ...
	 switch (calidad) {
	    ...
	    case "t2":
	     	 $('#carne').show();
	        var precio_carne = carne_total*5990;
	    ...
	    case "t3":
	      	$('#carne').show();
	        var precio_carne = carne_total*11990;
	    ...
	    case "t4":
	      	$('#carne').show();
	        var precio_carne = carne_total*22990;
	  ...
	  var precio_total = precio_carne + precio_embutido + carbon * 2800 + pan/12 * 1500;
